...
english_banned_words = set(csv_functions.lines_from_file(foreign_language['english_banned']))

english_frequency = csv_functions.tuples_from_csv(foreign_language['english_frequency'], delimeter=' ')
