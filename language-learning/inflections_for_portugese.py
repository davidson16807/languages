...
from languages.romance import definiteness, ModernRomanceRuleSyntax
    ...
    ListSemantics(
        case_usage_population.index(
            case_usage_annotation.annotate(
                tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/case-usage.tsv'))),
        mood_usage_population.index(
            mood_usage_annotation.annotate(
                tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/mood-usage.tsv'))),
        ...
        NestedDictLookup(
            conjugation_population.index([
                *finite_annotation.annotate(
                    tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/finite-conjugations.tsv')),
                # *nonfinite_annotation.annotate(
                #     tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/nonfinite-conjugations.tsv')),
            ])),
        NestedDictLookup(
            declension_population.index([
                *common_noun_annotation.annotate(
                    tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/common-noun-declensions.tsv')),
                *pronoun_annotation.annotate(
                    tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/pronoun-declensions.tsv')),
            ])),
        NestedDictLookup(
            declension_population.index([
                *possessive_pronoun_annotation.annotate(
                    tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/pronoun-possessives.tsv')),
                *common_noun_annotation.annotate(
                    tsv_parsing.rows('data/inflection/indo-european/romance/portugese/modern/adjective-agreements.tsv')),
            ])),
    ),
...
foreign_termaxis_to_terms = {
    ...
    **parse_any.token_to_tokens('''
        adjective: happy
        verb : be-inherently be-momentarily have go possess put work eat hear
        noun : man woman
    '''),
}
...
conjugation_subject_traversal = parse.termpath(
    ...
    '''
    1  singular masculine informal
    2  singular feminine  informal
    2  singular feminine  formal
    3  singular masculine informal
    1  plural   masculine informal
    2  plural   feminine  informal
    3  plural   masculine informal
    ''')
...
pronoun_traversal = parse.tokenpath(
    ...
    '''
    man    1 singular informal  masculine   
    woman  2 singular informal  feminine 
    woman  2 singular formal    feminine 
    man    3 singular informal  masculine
    woman  3 singular informal  feminine 
    man    1 plural   informal  masculine   
    woman  1 plural   informal  feminine
    man    2 plural   informal  masculine
    woman  2 plural   informal  feminine 
    man    3 plural   informal  masculine
    woman  3 plural   informal  feminine 
    ''')
