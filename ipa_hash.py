...
def ipa_narrow_hash(pronunciations):
...
def ipa_broad_hash(pronunciations):
...
def ipa_mispronunciation_hash(pronunciations):
    replacements = {
        ('b', 'p'),
        ('d', 't'),
        ('g', 'k'),
    ...
    for word, layer, pronunciation in ipa_broad_hash(pronunciations):
        simplification = pronunciation
        for old, new in replacements:
            simplification = simplification.replace(old, new)
        yield word, layer, simplification
